...
public class DialogGroupCreate extends DialogFragment {
    ActivityResultLauncher<String> getContent;
    DialogEditProfileBinding binding;
    DialogGroupCreateViewModel viewModel;
    MainActivityViewModel activityViewModel;
    public DialogGroupCreate() {

    }
    ButtonClickCallback clickReady = () ->{
        if(!binding.dialogEditName.getText().toString().equals("")){
            viewModel.createGroup(binding.dialogImage.getDrawable(),
    ...
    public static DialogGroupCreate getInstance(){
        DialogGroupCreate dialog = new DialogGroupCreate();
        return dialog;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(DialogGroupCreateViewModel.class);
